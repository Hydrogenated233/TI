let texts = [
    ...
    {
        text: `获得一个无限新闻之后你会解锁新闻挑战，每完成一个挑战会解锁一个自动器，当你把自动无限器升到满级后，就可以打破无限。<button onclick="window.location.href='https://g1tyx.github.io/antimatter-dimensions/new/'" class="btn">点我玩这个游戏</button>`
    },
    ...
    {
        text: `<a style="background-color:yellow;color:black;">要警惕黄色新闻</a>`
    },
    {
        text: `<a onclick="player.trees=player.trees.add(1)">点一下加一棵树</a>`
    },
    {
        text: `物理学家证明了黑洞是因为触发了一次无奖励的<a class="soft">引力</a>重置而形成的。`
    },
    
    {
        text: `本游戏没有任何bug。如有疑问，可拨打1.97e10询问。`
    },
    {
